...
#SBATCH -n 1 -N1
#SBATCH --mem="100M"
#SBATCH --job-name=h2o-molecule_PIMD_efficient_sampling_xxxTxxxK

ipi=~/source/i-pi/bin/i-pi

export OMP_NUM_THREADS=1

touch /tmp/ipi_h2o-molecule_PIMD_efficient_sampling_xxxTxxxK
rm /tmp/ipi_h2o-molecule_PIMD_efficient_sampling_xxxTxxxK
